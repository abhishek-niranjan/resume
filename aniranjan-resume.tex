...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Lead Engineer}{Mar 2020 - Present}
      \resumeItemListStart
      ...
      \resumeItem{Speech-to-Speech Translation}
            {Presently working on speech translation problem involving conversion of Korean audio signal features to English audio signal features. Using Transformer model as the fundamental sequence-to-sequence architecture with addition of auxiliary decoders to train on parallel tri-phone aligned data.}
      \resumeItemListEnd
